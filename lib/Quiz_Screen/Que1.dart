import 'package:demo_application/Quiz_Screen/Que2.dart';
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  const Text(
                    "Which macronutrient is essential for preserving lean muscle mass during fat loss?",
            ...
            // Answer Options
            _buildOption(0, "Carbohydrates"),
            _buildOption(1, "Fats"),
            _buildOption(2, "Proteins"),
            _buildOption(3, "Sugars"),
              ...
              children: [
                ...
                ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => Que2()),
                    );
                  },
                  style: ElevatedButton.styleFrom(
